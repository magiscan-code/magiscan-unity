...
### Removed
- The **Advanced ▸ Server URL** field on the connect screen. The server address is built in; the
  `MAGISCAN_BASE_URL` environment variable still overrides it for staging/QA.
